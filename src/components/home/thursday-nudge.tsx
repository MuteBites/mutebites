...
export function ThursdayNudge({ special }: { special: ThursdaySpecial }) {
  return (
    <Link
      ...
      className="pressable mt-4 flex items-center gap-3 rounded-2xl border border-brand-soft-foreground/15 bg-brand-soft px-4 py-3.5 outline-none focus-visible:ring-3 focus-visible:ring-ring/40"
    >
